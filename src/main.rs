...
async fn main() {
    ...
    let app_routes = Router::new()
        ...
        .route("/api/disk/info", get(routes::disk::get_disk_info_handler))
        .route("/api/disk/mount", post(routes::disk::mount_device_handler))
        .route("/api/disk/umount", post(routes::disk::umount_device_handler))
        ...
        .route("/api/firewall/reset", post(routes::firewall::reset_ufw))
        ...
        .route("/api/fail2ban/reset", post(routes::fail2ban::reset_fail2ban))
        ...
        .route("/api/cloudflare/reset", post(routes::cloudflare::reset_cloudflare))
